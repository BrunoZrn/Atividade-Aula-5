...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['comprar'])) {
        if ($_SESSION['estoque'] > 0) {
            // Diminui o estoque e redireciona para a página de sucesso
            $_SESSION['estoque']--;
            header("Location: obrigado.html");
            exit(); // O exit é obrigatório após um header redirect
        } else {
            // Se alguém tentar comprar e o estoque já for 0, manda para esgotado
